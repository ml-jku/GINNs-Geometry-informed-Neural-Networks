...
class ConditionalWIREDensity(nn.Module):
    '''
    ...
    def __init__(self, layers: List[int],
        ...
        self.density_iso_level = density_iso_level
        # All results in the paper were with the default complex 'gabor' nonlinearity
    ...
    def forward(self, x, z):
        ...
        # apply sigmoid and subtract iso_level_offset to ensure that the output is in (-iso_level_offset, 1-iso_level_offset)
        output = torch.sigmoid(output) - self.density_iso_level
        return output